...
LIBARCHIVE_CONF_OPTS += -DENABLE_UNZIP=ON
ifeq ($(BR2_STATIC_LIBS),y)
LIBARCHIVE_CONF_OPTS += -DENABLE_UNZIP_SHARED=OFF
else
LIBARCHIVE_CONF_OPTS += -DENABLE_UNZIP_SHARED=ON
endif
else
LIBARCHIVE_CONF_OPTS += -DENABLE_UNZIP=OFF
endif
