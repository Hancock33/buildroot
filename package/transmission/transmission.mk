...
TRANSMISSION_CONF_OPTS += -DCMAKE_C_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-gcc
TRANSMISSION_CONF_OPTS += -DCMAKE_CXX_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-g++
TRANSMISSION_CONF_OPTS += -DENABLE_QT=ON -DUSE_QT_VERSION=6 -DENABLE_NLS=OFF
TRANSMISSION_DEPENDENCIES += qt6base qt6svg qt6tools
endif
