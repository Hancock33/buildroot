...
#git describe --abbrev=40 origin/binutils-2_42-branch | cut -d '-' -f 2-
	BINUTILS_VERSION = 2_42-110-g01fbf04cb4214df16c7262f4c76d3a07bb825d35
	BINUTILS_SITE = $(call github,sailfishos-mirror,gdb,$(BINUTILS_VERSION))
